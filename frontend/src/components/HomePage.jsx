...
import useListenConnectionRequests from '../hooks/useListenConnectionRequests';


const HomePage = () => {
    useListenMessages(); // Listen to incoming socket messages globally while logged in
    useListenConnectionRequests(); // Listen to connection request updates globally while logged in
